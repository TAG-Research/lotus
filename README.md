# LOTUS:  An Engine For Querying with LLMs Over Data
<!--- BADGES: START --->
...
Below are just a few semantic operators provided by LOTUS. For more details, check out the full documentation [documentation](https://lotus-ai.readthedocs.io/en/latest/), or [colab tutorial](https://colab.research.google.com/drive/1OzoJXH13aOwNOIEemClxzNCNYnqSGxVl?usp=sharing)
